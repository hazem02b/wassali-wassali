...
/// Page d'inscription Transporteur (copie exacte de la version web)
...
class _SignupTransporterPageState extends State<SignupTransporterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      await _apiService.registerTransporter(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInputField(
                  ...
                  hintText: '${t('eg')} Voiture, Camionnette, Moto',
                  isDark: isDark,
                ...
                _buildInputField(
                  ...
                  hintText: '${t('eg')} 50kg, 100kg, 500kg',
                  isDark: isDark,
                  keyboardType: TextInputType.text,
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      disabledBackgroundColor: const Color(0xFFFF9500).withOpacity(0.5),
